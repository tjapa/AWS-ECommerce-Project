...
export class AuthInfoService {
  private cognitoIdentityServiceProvicer: CognitoIdentityServiceProvider

  constructor(cognitoIdentityServiceProvider: CognitoIdentityServiceProvider) {
    this.cognitoIdentityServiceProvicer = cognitoIdentityServiceProvider
  }
  ...
  async getUserInfo(
    ...
    const user = await this.cognitoIdentityServiceProvicer
      .adminGetUser({
